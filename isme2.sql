...
CREATE TABLE `class_photos`  (
  ...
  `tag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '标签，默认是寝室号',
...
-- ----------------------------
INSERT INTO `class_photos` VALUES (1, '我是宿舍2的', 2, 'http://dummyimage.com/400x400', '');
INSERT INTO `class_photos` VALUES (2, 'gouyuan', 1, 'http://dummyimage.com/600x400', '傻逼');
INSERT INTO `class_photos` VALUES (3, 'taidi', 2, 'http://dummyimage.com/800x400', '');
INSERT INTO `class_photos` VALUES (7, '和天红状查', 1, 'http://dummyimage.com/400x700', '');
INSERT INTO `class_photos` VALUES (11, 'asdasda', 4, 'asdasd', '');
...
CREATE TABLE `dormitory`  (
  ...
  `contain_nums` int(11) NOT NULL DEFAULT 100 COMMENT '相册的容量（可以保存的数量）',
  `photo_nums` int(11) NOT NULL DEFAULT 0 COMMENT '当前相册的数量',
...
-- ----------------------------
INSERT INTO `dormitory` VALUES (1, '251', '是地方个梵蒂冈是地方个梵蒂冈是地方个梵蒂冈是地方个梵蒂冈是地方个梵蒂冈是地方个梵蒂冈', 'https://miniprogram.fancyzh.top/foods/dumplings-8.jpg\nhttps://miniprogram.fancyzh.top/foods/dumplings-8.jpg', 0, 0, 251);
INSERT INTO `dormitory` VALUES (2, '517', '6789', 'https://unpkg.com/wot-design-uni-assets/meng.jpg', 0, 0, 251);
INSERT INTO `dormitory` VALUES (3, 'sfd', '是地方个梵蒂冈', 'https://unpkg.com/wot-design-uni-assets/meng.jpg\nhttps://unpkg.com/wot-design-uni-assets/meng.jpg', 0, 0, 253);
INSERT INTO `dormitory` VALUES (4, '测试1', 'wetfre', 'https://unpkg.com/wot-design-uni-assets/meng.jpg\nhttps://unpkg.com/wot-design-uni-assets/meng.jpg', 100, 0, 251);
INSERT INTO `dormitory` VALUES (7, '测试4', '电饭锅放到', 'asdsad\nasfdsf\ndfgfdg', 100, 0, 457);
INSERT INTO `dormitory` VALUES (8, '男寝', '士大夫', 'yui', 100, 0, 239);
INSERT INTO `dormitory` VALUES (9, '女寝', 'yui', 'yui', 100, 0, 782);
...
INSERT INTO `permission` VALUES (26, '寝室管理', 'Config', 'MENU', 24, '/photos/config', NULL, 'i-fe:settings', '/src/views/photos/config/index.vue', '', NULL, NULL, NULL, 1, 1, 2);
INSERT INTO `permission` VALUES (27, '成员管理', 'DormConf', 'MENU', 24, '/photos/dormconf', NULL, 'i-fe:settings', '/src/views/photos/member/index.vue', '', NULL, NULL, NULL, 1, 1, 2);
...
INSERT INTO `profile` VALUES (2, NULL, 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif?imageView2/1/w/80/h/80', NULL, NULL, 2, NULL);
...
INSERT INTO `user` VALUES (2, 'zwt123', '$2a$10$CJt1mmsbBXaHrP8iD8Vn7udloBPasDeexzvq5QKkuftcQpRelhmC.', 1, '2024-01-17 16:16:21.349918', '2024-01-17 16:16:21.349918');
